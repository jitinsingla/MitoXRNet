...
| `--pretrained 2` | Use **pretrained UNetDeep with Combined loss** weights from paper `output/Pretrained_Weights/`, link to the [UNetDeep_Combined](https://drive.google.com/drive/folders/1ERnxFkRweSzqcIoNNmrSTytvAv3uJzrG) model |
